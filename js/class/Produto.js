function Produto(){
    this.cadastrar=function(){
        ...
        $.ajax({
            ...
            error: function(jqXHR, textStatus, errorThrown){errorCase(textStatus, errorThrown, btnText, cadastrarProduto);}
        });
    };
    this.buscarDados=function(){
        ...
        $.ajax({
            ...
            error: function(jqXHR, textStatus, errorThrown){errorCase(textStatus, errorThrown, btnText, buscarDadosProduto);}
        });
    };
    this.atualizar=function(){
        ...
        $.ajax({
            ...
            success: function(dados){successCase(dados, btnText);},
            error: function(jqXHR, textStatus, errorThrown){errorCase(textStatus, errorThrown, btnText, atualizarProduto);}
        });
    };
}