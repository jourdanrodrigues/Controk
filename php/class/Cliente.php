...
class Cliente extends Contato{
    ...
    public function buscarDadosCliente(){
        ...
        echo fixJSON("{'idCliente':$this->idCliente,
            'nome':'".$this->getValue('nome','cliente','id',$this->idCliente)."',
            'cpf':'".$this->getValue('cpf','cliente','id',$this->idCliente)."',
            'obs':'".$this->getValue('obs','cliente','id',$this->idCliente)."',".
