...
<html>
    <head>
        ...
        <?php
            ...
            loadFiles("{'css':['bootstrap','sweetalert']}");
        ...
        ?>
        <style>/* fixar elementos da nav-bar no centro */
            *{outline:none !important}
            ...
            .action span{margin-top:9px}
            .filter input:not(:last-child){margin-bottom:6px}
            tr th{text-align:center !important}
            .moreInfo,.edit,.navbar-nav{cursor:pointer}
            @media screen and (min-width: 768px) {
                ...
                .action span{margin:20px 0 0 1px}
            }
        </style>
        <script>
            $(document).ready(function(){
                ...
                $("input[class*='item_']").click(function(){
                    var classes=($("input:checked").length!=0?["plus","minus"]:["minus","plus"]),
                        color=$("input:checked").length!=0?"red":"green";
                    $(".action").css("background",color).attr("title",color=="red"?"Excluir":"Cadastrar");
    ...
    <body>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse">
                            <ul class="nav navbar-nav">
                                <li class="active"><a>Funcionário</a></li>
                    ...
                    <div class="col-lg-2 col-lg-offset-1">
                        <div class="panel panel-primary filter">
                            ...
                            <div class="panel-body">
                                <input type="text" class="form-control" data-search="nome" placeholder="Nome">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><input type="checkbox" class="item_0_1"></td> <!-- item_numCampo_idCad -->
                                            <td>Josinildo</td>
                                            <td>Marceneiro</td>
                                            <td>056.741.852-45</td>
                                            <td class="moreInfo"><span class="glyphicon glyphicon-eye-open"></span></td>
                                            <td class="edit"><span class="glyphicon glyphicon-pencil"></span></td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox" class="item_1_2"></td>
                                            <td>Thiago Jourdan</td>
                                            <td>Fodão</td>
                                            <td>056.741.852-45</td>
                                            <td class="moreInfo"><span class="glyphicon glyphicon-eye-open"></span></td>
                                            <td class="edit"><span class="glyphicon glyphicon-pencil"></span></td>
        ...
        <div class="panel panel-default action" title="Cadastrar">
            <div class="panel-body"><span class="glyphicon glyphicon-plus"></span></div>
        </div>
    </body>
</html>